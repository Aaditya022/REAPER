...
export function SecuritySection() {
  ...
  return (
    <section id="security" ref={sectionRef} className="relative pt-20 lg:pt-28 pb-32 lg:pb-40 overflow-hidden">
      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className="mb-16">
          ...
          {/* Title — full width */}
          <h2 className={`text-[2rem] md:text-[2.5rem] lg:text-[3.25rem] font-display font-bold tracking-[-0.01em] leading-[1.15] mb-12 transition-all duration-1000 ${
          ...
          <div className={`transition-all duration-1000 delay-100 ${
            ...
            <p className="text-xl text-muted-foreground leading-[1.6] max-w-2xl">
              REAPER keeps your credentials local, validates your environment before deploy, and verifies the live URL over HTTPS before anything ships.
            </p>
          </div>
        </div>
        ...
        <div className="grid lg:grid-cols-12 gap-6">
          ...
          <div className={`lg:col-span-7 relative p-8 lg:p-12 border border-foreground/10 min-h-[400px] overflow-hidden transition-all duration-700 ${
            ...
            <div className="relative z-10">
              <span className="text-base font-medium text-muted-foreground">Active verification</span>
              <div className="mt-8">
                <span className="text-5xl lg:text-6xl leading-none font-display font-bold">3</span>
                <span className="block text-base text-muted-foreground mt-4 max-w-sm">Consecutive unreachable attempts before a deployment fails</span>
              </div>
            </div>
