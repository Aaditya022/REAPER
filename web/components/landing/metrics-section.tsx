...
const metrics = [
  { 
    ...
    prefix: "",
    label: "Engine tests",
    sublabel: "passing in the deployment engine",
  },
  { 
    value: 7, 
    suffix: "", 
    ...
    sublabel: "PENDING through HEALTHY",
  },
  { 
    value: 2, 
    suffix: "s", 
...
export function MetricsSection() {
  ...
  return (
    <section ref={sectionRef} className="relative pt-20 lg:pt-28 pb-32 lg:pb-40 overflow-hidden">
      <GridBackground />
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className="grid lg:grid-cols-12 gap-8 mb-16 lg:mb-20">
          <div className="lg:col-span-8 lg:col-start-1">
            <div className="flex items-center gap-4 mb-6">
              <span className="flex items-center gap-2 px-3 py-1 bg-[#eca8d6]/10 text-[#eca8d6] text-sm font-medium uppercase tracking-wider">
            ...
            <h2 className={`text-[2rem] md:text-[2.5rem] lg:text-[3.25rem] font-display font-bold tracking-[-0.01em] leading-[1.15] transition-all duration-1000 ${
              ...
              Real-time
              <br />
              deployment <span className="accent-word">stats.</span>
            </h2>
          </div>
        </div>
        ...
        <div className="grid lg:grid-cols-3 gap-6">
          ...
          <div className={`lg:col-span-1 bg-foreground/[0.02] border border-foreground/10 p-10 lg:p-14 transition-all duration-700 ${
            ...
            <div className="text-4xl md:text-5xl lg:text-6xl font-display font-bold tracking-[-0.01em] mb-4 whitespace-nowrap overflow-hidden">
            ...
            <div className="text-lg font-semibold text-foreground mb-2">{metrics[0].label}</div>
            <div className="text-base text-muted-foreground">{metrics[0].sublabel}</div>
          </div>
          ...
          {metrics.slice(1).map((metric, index) => (
            ...
            >
              <div className="w-full">
                <div className="text-base font-medium text-muted-foreground mb-2">{metric.sublabel}</div>
                <div className="text-lg font-medium text-foreground mb-3">{metric.label}</div>
                <DotGraph
              ...
              <div className="text-3xl md:text-4xl lg:text-5xl font-display font-bold tracking-[-0.01em] w-full">
        ...
        {/* Bottom ticker */}
        <div className={`mt-16 pt-8 border-t border-foreground/10 flex flex-wrap items-center gap-x-12 gap-y-4 text-base font-medium text-muted-foreground transition-all duration-1000 delay-500 ${
          isVisible ? "opacity-100" : "opacity-0"
        }`}>
          <span>React</span>
          <span>Next.js</span>
          ...
          <span>Angular</span>
          <span>ExpressJS</span>
          <span className="text-foreground">+9 more stacks</span>
        </div>
      </div>
    </section>
  );
